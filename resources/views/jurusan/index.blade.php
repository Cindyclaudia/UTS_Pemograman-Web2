...
<body>
    ...
    <div class="main-content">
        <div class="topbar">
            <h5><i class="fas fa-building me-2 text-danger"></i>Data Jurusan</h5>
            <div class="user-info">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge-akreditasi {{ $jurusan->akreditasi == 'A' ? 'badge-a' : ($jurusan->akreditasi == 'B' ? 'badge-b' : 'badge-c') }}">
                                        Akreditasi {{ $jurusan->akreditasi }}
                                    </span>
                                </td>
                                <td>
                                    <a href="{{ route('jurusan.edit', $jurusan->id_jurusan) }}" class="btn-edit me-1">
                                        <i class="fas fa-edit me-1"></i>Edit
                                    </a>
                                    <form action="{{ route('jurusan.destroy', $jurusan->id_jurusan) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin hapus jurusan ini?')">
                                        @csrf
                                        @method('DELETE')
                            ...
                            @empty
                            <tr><td colspan="4" class="text-center py-4 text-muted">Belum ada data jurusan</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
