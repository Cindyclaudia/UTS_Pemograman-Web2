...
<head>
    ...
    <style>
        ...
        .btn-simpan:hover { transform: translateY(-1px); color: #fff; }
        .btn-batal {
...
<body>
    ...
    <div class="main-content">
        <div class="topbar">
            <h5><i class="fas fa-plus me-2 text-danger"></i>Tambah Jurusan</h5>
            <div class="user-info">
        ...
        <div class="content-area">
            <div class="form-card">
                <div class="form-card-header">
                    <h5><i class="fas fa-plus-circle me-2"></i>Form Tambah Jurusan</h5>
                </div>
                <div class="form-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('jurusan.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label"><i class="fas fa-building me-2 text-danger"></i>Nama Jurusan</label>
                            <input type="text" name="nama_jurusan" class="form-control" placeholder="Contoh: Teknik Informatika" value="{{ old('nama_jurusan') }}" required>
                        </div>
                        <div class="mb-4">
                            <label class="form-label"><i class="fas fa-star me-2 text-danger"></i>Akreditasi</label>
