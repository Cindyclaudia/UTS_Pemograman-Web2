...
<body>
    ...
    <div class="main-content">
        <div class="topbar">
            <h5><i class="fas fa-edit me-2 text-warning"></i>Edit Matakuliah</h5>
            <div class="user-info">
        ...
        <div class="content-area">
            <div class="form-card">
                <div class="form-card-header">
                    <h5><i class="fas fa-edit me-2"></i>Form Edit Matakuliah</h5>
                </div>
                <div class="form-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('matakuliah.update', $matakuliah->id_matakuliah) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="mb-3">
                            <label class="form-label"><i class="fas fa-book me-2 text-warning"></i>Nama Matakuliah</label>
                            <input type="text" name="nama_matakuliah" class="form-control" value="{{ $matakuliah->nama_matakuliah }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><i class="fas fa-hashtag me-2 text-warning"></i>SKS</label>
