...
<body>
    ...
    <div class="main-content">
        <div class="topbar">
            <h5><i class="fas fa-plus me-2 text-danger"></i>Tambah Matakuliah</h5>
            <div class="user-info">
        ...
        <div class="content-area">
            <div class="form-card">
                <div class="form-card-header">
                    <h5><i class="fas fa-plus-circle me-2"></i>Form Tambah Matakuliah</h5>
                </div>
                <div class="form-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('matakuliah.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label"><i class="fas fa-book me-2 text-danger"></i>Nama Matakuliah</label>
                            <input type="text" name="nama_matakuliah" class="form-control" placeholder="Contoh: Pemrograman Web" value="{{ old('nama_matakuliah') }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><i class="fas fa-hashtag me-2 text-danger"></i>SKS</label>
                            <input type="number" name="sks" class="form-control" placeholder="Contoh: 3" value="{{ old('sks') }}" min="1" max="6" required>
                        </div>
                        <div class="mb-4">
                            <label class="form-label"><i class="fas fa-building me-2 text-danger"></i>Jurusan</label>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn-simpan"><i class="fas fa-save me-2"></i>Simpan</button>
                            <a href="{{ route('matakuliah.index') }}" class="btn-batal"><i class="fas fa-arrow-left me-2"></i>Batal</a>
                        </div>
                    </form>
                </div>
            </div>
