...
<body>
    ...
    <div class="main-content">
        <div class="topbar">
            <h5><i class="fas fa-edit me-2 text-warning"></i>Edit Mahasiswa</h5>
            <div class="user-info">
        ...
        <div class="content-area">
            <div class="form-card">
                <div class="form-card-header">
                    <h5><i class="fas fa-user-edit me-2"></i>Form Edit Mahasiswa</h5>
                </div>
                <div class="form-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('mahasiswa.update', $mahasiswa->id_mahasiswa) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="mb-3">
                            <label class="form-label"><i class="fas fa-id-card me-2 text-warning"></i>NIM</label>
                            <input type="text" name="nim" class="form-control" value="{{ $mahasiswa->nim }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><i class="fas fa-user me-2 text-warning"></i>Nama Mahasiswa</label>
                            <input type="text" name="nama" class="form-control" value="{{ $mahasiswa->nama }}" required>
                        </div>
                        <div class="mb-4">
                            <label class="form-label"><i class="fas fa-building me-2 text-warning"></i>Jurusan</label>
