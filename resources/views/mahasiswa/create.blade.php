...
<body>
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="{{ route('mahasiswa.index') }}" class="active"><i class="fas fa-user-graduate"></i> Mahasiswa</a></li>
    ...
    <div class="main-content">
        <div class="topbar">
            <h5><i class="fas fa-plus me-2 text-danger"></i>Tambah Mahasiswa</h5>
            <div class="user-info">
            ...
            <div class="form-card">
                ...
                <div class="form-body">
                    ...
                    <form action="{{ route('mahasiswa.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label"><i class="fas fa-id-card me-2 text-danger"></i>NIM</label>
                            <input type="text" name="nim" class="form-control" placeholder="Contoh: 2301001" value="{{ old('nim') }}" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><i class="fas fa-user me-2 text-danger"></i>Nama Mahasiswa</label>
                            <input type="text" name="nama" class="form-control" placeholder="Nama lengkap mahasiswa" value="{{ old('nama') }}" required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('mahasiswa.index') }}" class="btn-batal"><i class="fas fa-arrow-left me-2"></i>Batal</a>
                        </div>
                    </form>
                </div>
            </div>
